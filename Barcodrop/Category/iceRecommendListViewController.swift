...
extension iceRecommendListViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if dDay > 0 {
            ...
            cell.iceDday.layer.borderColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
            cell.iceDday.backgroundColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
        }else if dDay < 0 && dDay > -3 {
            cell.iceDday.setTitle("D\(dDay)", for: .normal)
            cell.iceDday.layer.borderColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
            cell.iceDday.backgroundColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
            ...
            if dDay > 0 {
                cell.iceDday.setTitle("\(dDay)일 지남", for: .normal)
                cell.iceDday.layer.borderColor = #colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1)
                cell.iceDday.backgroundColor = #colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1)
          
            }else if dDay == 0{
                cell.iceDday.setTitle("오늘까지", for: .normal)
                cell.iceDday.layer.borderColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
                cell.iceDday.backgroundColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
            }else if dDay < 0 && dDay > -3 {
                cell.iceDday.setTitle("\(dDay * -1)일 남음", for: .normal)
                cell.iceDday.layer.borderColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
                cell.iceDday.backgroundColor = #colorLiteral(red: 0.8275327086, green: 0, blue: 0, alpha: 1)
